<?php
/**
 * smarter_foundation functions and definitions
 *
...
if ( ! function_exists( 'smarter_foundation_setup' ) ) :
/**
 ...
 */
function smarter_foundation_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on smarter_foundation, use a find and replace
	 * to change 'smarter_foundation' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'smarter_foundation', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'smarter_foundation' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'smarter_foundation_custom_background_args', array(
...
endif; // smarter_foundation_setup
add_action( 'after_setup_theme', 'smarter_foundation_setup' );
 ...
 */
function smarter_foundation_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'smarter_foundation' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'smarter_foundation_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'smarter_foundation_scripts' );
